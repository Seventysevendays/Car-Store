...
export default class EditAvatar extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    // 发送对图片的url请求
    var img = new Image();
    img.src = '/upload/' + nextProps.picurl;
    // 备份this
    var self = this;
    img.onload = function () {
          ...
          !this.state.isUpDone
            ...
            <div className="cutBox" style={{
              ...
              <div className="imgBoxWrap" style={{
                ...
                <img src={`/upload/${this.props.picurl}`} style={{
                  "width": this.props.imgW + "px",
                  "height": this.props.imgH + "px",
                }} />
              ...
              <div className="previewZone" ref="previewZone">
                <div className="big_pic pic" data-w="160">
                  <img src={`/upload/${this.props.picurl}`} alt="" />
                </div>
                ...
                <Button type="primary" onClick={this.doCut.bind(this)}>确定</Button>
                {" "}
                <Button type="error" onClick={this.concel.bind(this)}>取消</Button>
              </div>
            </div>
        }
      </div>
